...
class PushButton extends React.Component {
    constructor(props) {
        ...
        this.setDarkSolidColorBackground = this.setDarkSolidColorBackground.bind(this);
    ...
    setDarkSolidColorBackground() {
        let darkName = 'dark' + this.props.color.charAt(0).toUpperCase() + this.props.color.slice(1);
        this.setState({
    ...
    render() {
        return (
            <button className={"push-button " + this.props.size + "-btn"}
                style={{
